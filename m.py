...
TOKEN = '7960283920:AAFyTX5MqhlfpKqYIta8ckzE_C3XoarMj5w'  # Replace with your actual bot token
CHANNEL_ID = '-1002261319850'  # Command handling group ID
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./daku {target_ip} {target_port} {default_duration} {6} {900}")
